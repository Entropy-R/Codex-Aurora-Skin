...
const featured = await fs.readFile(path.join(windowsRoot, "assets", "red-white-abstract.png"));
...
const cli = spawnSync(process.execPath, [helper, "--check", path.join(windowsRoot, "assets", "red-white-abstract.png")], {
  encoding: "utf8",
});
