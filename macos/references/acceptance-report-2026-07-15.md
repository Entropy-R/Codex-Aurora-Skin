...
Codex Aurora Skin `1.0.0` passed its macOS release checks on the live Codex desktop app during the original private release validation.
...
```bash
~/.codex/codex-aurora-skin/scripts/verify-aurora-skin-macos.sh \
  --reload --screenshot "$HOME/Desktop/Codex Aurora Skin Verification.png"
```
